...
/**
 * Minimal implementation of the yoomoney-sdk helpers:
 *  - REST API client (account-info, operation-history, operation-details, request-payment, process-payment)
 *  - Payment form builder
 *  - Notification checker/middleware
 */
class API {
