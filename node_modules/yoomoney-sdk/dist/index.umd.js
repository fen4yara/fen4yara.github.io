(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("axios"), require("querystring"), require("redirect-form-builder"), require("crypto")) : typeof define === "function" && define.amd ? define(["exports", "axios", "querystring", "redirect-form-builder", "crypto"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global["yoomoney-sdk"] = {}, global.axios, global.querystring, global.redirectFormBuilder, global.crypto));
})(this, function(exports2, axios, querystring, redirectFormBuilder, crypto) {
  "use strict";
  async function fetch(url, parameters, headers = {}, agent) {
    return await axios.post(url, querystring.stringify(parameters), {
      headers: {
  ...
  class NotificationChecker {
    ...
    check(notification) {
      ...
      if (!crypto.timingSafeEqual(hash, original)) {
  ...
  class PaymentFormBuilder {
    ...
    buildHtml(fullPage = false) {
      ...
      return new redirectFormBuilder.FormBuilder(this.url, "POST", fields).buildHtml(fullPage);
    }
  }
  exports2.API = API;
  exports2.Auth = Auth;
  exports2.AuthScope = AuthScope;
  exports2.FormPaymentType = PaymentType;
  exports2.NotificationChecker = NotificationChecker;
  exports2.PaymentFormBuilder = PaymentFormBuilder;
  exports2.PaymentType = PaymentType;
  exports2.QuickPayForm = QuickPayForm;
  exports2.YMApi = API;
  exports2.YMApiError = YMApiError;
  exports2.YMApiVoidResponseError = YMApiVoidResponseError;
  exports2.YMAuth = Auth;
  exports2.YMAuthError = YMAuthError;
  exports2.YMFormPaymentType = PaymentType;
  exports2.YMNotificationChecker = NotificationChecker;
  exports2.YMNotificationError = YMNotificationError;
  exports2.YMPaymentFormBuilder = PaymentFormBuilder;
